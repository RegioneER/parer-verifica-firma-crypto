...
### Bugfix: 1
- [#40965](https://parermine.regione.emilia-romagna.it/issues/40965) Correzione gestione socket timeout su HTTP client generico
...
### Novità: 3
- [#39186](https://parermine.regione.emilia-romagna.it/issues/39186) Modifica validazione e verifica validità di documenti PDF (PADES)
- [#39162](https://parermine.regione.emilia-romagna.it/issues/39162) Aggiornamento Java Xml Security 4.x 
- [#39161](https://parermine.regione.emilia-romagna.it/issues/39161) Aggiornamento librerie Bouncy Castle 1.8x + Tika 3.x + xmlsec 2.x
