...
public class ApiIntegrationTest {
    ...
    public void testGetErrorDocument() {
        ...
        ResponseEntity<ParerErrorDoc> entity = restTemplate.getForEntity("/v1/errors/unhandled-exception",
                ParerErrorDoc.class);
    ...
    @Test
    public void testVerificaFirma() throws IOException {
        ...
        CryptoAroCompDoc componente = restTemplate.postForObject("/v1/report-verifica", entity, CryptoAroCompDoc.class);
    ...
    /**
     * Analogo al test precedente ma utilizzando il multipart (endpoint /v2)
     *
     * @throws IOException
     */
    @Test
    public void testVerificaFirmav2() throws IOException {
        ...
        CryptoAroCompDoc componente = restTemplate.postForObject("/v2/report-verifica", entity, CryptoAroCompDoc.class);
     ...
     */
    @Test
    public void testVerificaFirmav2P7m() throws IOException {
     ...
     */
    @Test
    public void testVerificaFirmaV2NoMetadata() throws IOException {
    ...
    @Test
    public void testVerificaFirmaV2TimestampDetached() throws Exception {
    ...
    @Test
    public void testVerificaFirmaV2TimestampDetachedNoMetadata() throws Exception {
    ...
    @Test
    public void testInputIncoerente() throws FileNotFoundException {
        File fileFirmato = ResourceUtils.getFile("classpath:firme/cades_T_1.pdf.p7m");
        ...
        assertThrows(CryptoParerException.class, () -> {
            restTemplate.postForObject("/v2/report-verifica", entity, CryptoAroCompDoc.class);
        });
    }

    @Test
    public void testVerificaFirma2() throws Exception {
    ...
    @Test
    public void testVerificaFirmaFileLocale() throws IOException {
        Resource fileFirmato = resourceLoader.getResource("classpath:firme/xml_sig_controfirma_cert_rev.xml");
    ...
    public void testConfigurazioneNonCoerente() throws IOException {
        ...
        Assertions.assertThrows(CryptoParerException.class, () -> {
            restTemplate.postForObject("/v1/report-verifica", entity, CryptoAroCompDoc.class);
        });

    }

    @Test
    public void testConfigurazioneNulla() throws IOException {
        Resource fileFirmato = resourceLoader.getResource("classpath:firme/p7m_pem_sha256.pdf.p7m");
        CryptoDataToValidate input = new CryptoDataToValidate();
    ...
    @Test
    public void testProfiloDefault() throws IOException {
        Resource fileFirmato = resourceLoader.getResource("classpath:firme/p7m_pem_sha256.pdf.p7m");
        CryptoDataToValidate input = new CryptoDataToValidate();
        input.setContenuto(new CryptoDocumentoVersato("P7M_3", Resources.toByteArray(fileFirmato.getURL())));
        ...
        HttpEntity<CryptoDataToValidate> entity = new HttpEntity<>(input, headers);
        restTemplate.getRestTemplate().setErrorHandler(new CryptoErrorHandler());
        CryptoAroCompDoc postForObject = restTemplate.postForObject("/v1/report-verifica", entity,
                CryptoAroCompDoc.class);
    ...
    @Test
    public void testProfiloCustom() throws IOException {
        Resource fileFirmato = resourceLoader.getResource("classpath:firme/p7m_pem_sha256.pdf.p7m");
        CryptoDataToValidate input = new CryptoDataToValidate();
        input.setContenuto(new CryptoDocumentoVersato("P7M_3", Resources.toByteArray(fileFirmato.getURL())));
    ...
    @Test
    public void configurazioneDataRiferimentoNonCoerente() throws IOException {
        Resource fileFirmato = resourceLoader.getResource("classpath:firme/p7m_pem_sha256.pdf.p7m");
        CryptoDataToValidate input = new CryptoDataToValidate();
        input.setContenuto(new CryptoDocumentoVersato("P7M_3", Resources.toByteArray(fileFirmato.getURL())));
    ...
    public void testTimestamp() throws IOException {
        ...
        ParerTST postForObject = restTemplate.postForObject("/v1/tst", requestEntity, ParerTST.class);
    ...
    @Test
    public void testTSD() throws IOException {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
        ...
        body.add("file", resource);
        HttpEntity<MultiValueMap<String, Object>> requestEntity = new HttpEntity<>(body, headers);
        ParerTSD postForObject = restTemplate.postForObject("/v1/tsd", requestEntity, ParerTSD.class);
     ...
     */
    @Test
    public void testSearchCrl() throws IOException {
        ...
        HttpEntity<String> requestEntity = new HttpEntity(createArrayNode.toString(), headers);

        restTemplate.getRestTemplate().setErrorHandler(new CryptoErrorHandler());
        final ParerCRL expectedCrl = restTemplate.postForObject("/v1/crl", requestEntity, ParerCRL.class);
        ...
        String url = "/v1/crl?certifFirmatarioBase64UrlEncoded=" + certificatoFirmatarioBase64;
