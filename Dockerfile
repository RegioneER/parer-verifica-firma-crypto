...
#
# docker build -f src/main/docker/Dockerfile.jvm -t verifica-firma-crypto .
#
# Then run the container using:
#
# docker run -i --rm -p 8080:8080 verifica-firma-crypto
#
...
LABEL io.k8s.description="Microservizio verifica firma CRYPTO (basato su immagine ubi RedHat)" \
      ...
      io.openshift.tags="crypto,java,microservice" \
      app="verifica-firma-crypto" \ 
      group="it.eng.parer"
...
COPY --chown=185 target/*.jar /deployments/old-cryptolibrary.jar
