...
public class CryCrl implements Serializable {
     ...
     * sarebbero normalmente espresse in UTC/GMT Il sistema però persistente con il TZ locale (ossia
     * GMT+01), esiste un caso "particolare" di timestamp : 9999/31/12 23:59:59 UTC che per un hard
     * limit di ORACLE DB non può essere persisto (la sua conversione in GMT+01 lo trasforma in
     * 10000/01/01 00:59:59 GMT+01) che non può essere persistito e/o letto
     */
    @PrePersist
