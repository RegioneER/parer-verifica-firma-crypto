...
/**
 * Session Bean implementation class Crl . Il name del service deve essere
 * {@link CryptoConstants#ICRLSTORAGE}
 */
...
public class CRLHelper implements CRLHelperLocal {
     ...
     * Ottieni la CRL
     *
     * @param subjectDN DN del subject
     * @param keyId     id della chiave
     *
     * @return CRL di BouncyCastle
     *
     * @throws CryptoStorageException eccezione di persistenza
     */
    @Override
