...
public class OldCryptoInvoker {
     ...
     *
     * @param content contenuto per il quale generare il TSD
     *
     * @return CMSTimeStampedData del contenuto
     *
     * @throws CMSException             eccezione durante l'applicazione dei metodi di BC
     * @throws IOException              errore generico di I/O
     * @throws NoSuchAlgorithmException algoritmo per il digest non fornito dalla JVM o BC
     * @throws NoSuchProviderException  provider non fornito dalla JVM o BC
     * @throws TSPValidationException   problema di validazione del timestamp "staccato" dalla TSA
     ...
     *
     * @param content byte array da marcare
     *
     * @return TimeStampToken di BC
     *
     * @throws IOException              in caso di generico errore di I/O
     * @throws NoSuchAlgorithmException per il calcolo dello SHA-256
     * @throws NoSuchProviderException  in caso non sia presente BC
     * @throws TSPValidationException   validazione dopo l'emissione della marca temporale errata
