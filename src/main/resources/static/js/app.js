...
$(document).ready(function() {
	...
	// Copy to clipboard functionality for code badges
	$('.code-badge').on('click', function() {
	    var $icon = $(this).find('.code-badge-copy-icon');
	    // Copy logic here (e.g., copy text to clipboard)
