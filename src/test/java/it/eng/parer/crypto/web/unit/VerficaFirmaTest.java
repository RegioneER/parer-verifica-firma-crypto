...
class VerficaFirmaTest {
    ...
    @Test
    void testVerificaCadesBesPadesT() throws Exception {
	Resource cadesBesPadesT = resourceLoader
    ...
    @Test
    void testXadesT_BES() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.XADES_T,
		Util.XMLSHA256RSA, 1);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(1), SignerType.XADES_T,
		Util.XMLSHA256RSA, 1);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(2), SignerType.XADES_BES,
		Util.XMLSHA256RSA, 1);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(0), SignerType.XADES_T,
		Util.SHA256RSA, 1);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(1), SignerType.XADES_T,
		Util.SHA256RSA, 1);
	...
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
		...
		componente.getAroMarcaComps().get(0).getTmMarcaTemp());
	...
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(2),
		VerificheEnums.TipoRifTemporale.DATA_FIRMA,
		componente.getAroFirmaComps().get(2).getDtFirma());

    }

    @Test
    void testXML_SIG_CertRevocatoDataVersamento() throws Exception {
	...
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoRifTemporale.DATA_VERS, dataTest);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(1),
		VerificheEnums.TipoRifTemporale.DATA_VERS, dataTest);
    ...
    @Test
    void testXML_SIG_CertRevocatoDataRiferimento() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/xml_sig_controfirma_cert_rev.xml");
    ...
    @Test
    void testP7M_PEM_SHA256() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.P7M,
		Util.SHA256RSA, 1);
	...
	Util.assertControlloFirmaKO(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoControlli.CERTIFICATO,
     ...
     */
    @Test
    void testXML_SIG() throws Exception {
     ...
     */
    @Test
    void testCadesBESMultipart() throws Exception {
	...
	data.setContenuto(
		new CryptoDataToValidateFile("documento-principale", fileFirmato.getFile()));
     ...
     */
    @Test
    void testCadesBES() throws Exception {
    ...
    @Test
    void test2CadesBES_CRL_Telecom() throws Exception {
     ...
     */
    @Test
    void testCadesBES_Controfirme() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(1), SignerType.CADES_BES,
		Util.SHA256RSA, 1);
	CryptoAroFirmaComp aroFirmaFiglio = componente.getAroFirmaComps().get(0)
		.getAroControfirmaFirmaFiglios().get(0).getAroFirmaFiglio();
    ...
    @Test
    void testCadesBES_Controfirma_CadesT() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER +
	// "/cades_bes_controfirma_cades_t.pdf.p7m");
	// Util.useRifTempVers(versManager);
	// Date rifVersato = Util.getDate(8, Calendar.SEPTEMBER, 2013);
	// verificaFirme(componente, fileWithSignature, rifVersato);
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.CADES_BES,
		Util.SHA256RSA, 1);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(1), SignerType.CADES_T,
		Util.SHA256RSA, 1);
	Util.assertControlliFirmeOK(componente);
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
     ...
     */
    @Test
    void testCadesBES_Pades_T() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.CADES_BES,
		Util.SHA256RSA, 1);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(1), SignerType.PADES,
		Util.SHA256RSA, 2);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(0), SignerType.PADES,
		Util.SHA256RSA, 2);
	Util.assertControlliFirmeOK(componente);
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
    ...
    @Test
    void testP7M_B64_DataFirma() throws Exception {
	...
	Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoControlli.CATENA_TRUSTED,
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoControlli.CATENA_TRUSTED_ABILITATO,
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
	...
	Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
		...
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoControlli.CRL, VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoRifTemporale.DATA_FIRMA,
    ...
    @Test
    void testP7M_B64_RifTemp() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/p7m_b64.xml.p7m");
	// Util.useRifTempVers(versManager);
	// Date rifVersato = Util.getDate(8, Calendar.SEPTEMBER, 2013);
	// verificaFirme(componente, fileWithSignature, rifVersato);
    ...
    @Test
    void testAbilitazioni() throws Exception {
     ...
     */
    @Test
    void testCadesT_BES() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(2), SignerType.CADES_BES,
		Util.SHA256RSA, 2);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(0), SignerType.CADES_T,
		Util.SHA256RSA, 1);
	Util.assertControlliFirmeOK(componente);
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
    ...
    @Test
    void testCadesT_BES_TSR() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/cades_T_1.pdf.p7m");
	...
	Resource fileFirmato = resourceLoader.getResource("classpath:firme/cades_T_1.pdf.p7m");
	Resource marcaDetached = resourceLoader
		.getResource("classpath:firme/cades_T_1.pdf.p7m.tsr");
    ...
    @Test
    void testFileNonFirmato_TSR() throws Exception {
	...
	Resource marcaDetached = resourceLoader
		.getResource("classpath:firme/test_non_firma.xml.tsr");
    ...
    @Test
    void testP7M_TSR() throws Exception {
	...
	// Util.assertFormatoMarcaOK(sottoComponente.getAroBustaCrittogs().get(0).getAroMarcaComps().get(0),
	// SignerType.TSR, Util.SHA1RSA, 1);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(1), SignerType.TSR,
		Util.SHA1RSA, 2);
	...
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(0),
		VerificheEnums.TipoControlli.CATENA_TRUSTED,
		VerificheEnums.EsitoControllo.NEGATIVO);
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(0),
		VerificheEnums.TipoControlli.CRL, VerificheEnums.EsitoControllo.NON_NECESSARIO);
    ...
    @Test
    void testP7M_MD5() throws Exception {
	...
	Util.assertNumeroDiBusteOK(componente, 1);
	Util.assertNumeroDiControfirmeOK(componente, 0);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.P7M, Util.MD5RSA,
		1);
	Util.assertControlloConformitaFirma(componente.getAroFirmaComps().get(0),
		VerificheEnums.EsitoControllo.NON_AMMESSO_DELIB_45_CNIPA);
	// Util.assertControlloFirmaSpecificoOK(componente.getAroFirmaComps().get(0),
    ...
    @Test
    void testTSD_Cades_BES() throws Exception {
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.CADES_BES,
		Util.SHA256RSA, 2);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(0), SignerType.TSD,
		Util.SHA256RSA, 1);
	Util.assertControlloConformitaFirma(componente.getAroFirmaComps().get(0),
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlliFirmeOK(componente);
    ...
    @Test
    void testTSR_VersatoComeComponente() throws Exception {
    ...
    @Test
    void testTSD_Cades_T() throws Exception {
    ...
    @Test
    void testTSD_Cades_T_TSR() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/tsd_cades_T.pdf.p7m.tsd");
	...
	Resource fileFirmato = resourceLoader
		.getResource("classpath:firme/tsd_cades_T.pdf.p7m.tsd");
	Resource marcaDetached = resourceLoader
		.getResource("classpath:firme/tsd_cades_T.pdf.p7m.tsd.tsr");
	...
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(2), SignerType.CADES_BES,
		Util.SHA256RSA, 3);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(1), SignerType.TSD,
		Util.SHA1RSA, 1);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(2), SignerType.CADES_T,
		Util.SHA256RSA, 2);
	// Util.assertFormatoMarcaOK(sottoComponente.getAroBustaCrittogs().get(0).getAroMarcaComps().get(0),
	// SignerType.TSR, Util.SHA1RSA, 1);
	Util.assertFormatoMarcaOK(componente.getMarche("marca-detached").get(0), SignerType.TSR,
		Util.SHA1RSA, 1);
	Util.assertControlliFirmeOK(componente);
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(0),
		VerificheEnums.TipoControlli.CATENA_TRUSTED,
	...
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(0),
		VerificheEnums.TipoControlli.CRL, VerificheEnums.EsitoControllo.NON_NECESSARIO);
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(1),
		VerificheEnums.TipoControlli.CATENA_TRUSTED,
		VerificheEnums.EsitoControllo.NEGATIVO);
	Util.assertControlloMarcaKO(componente.getAroMarcaComps().get(1),
		VerificheEnums.TipoControlli.CRL, VerificheEnums.EsitoControllo.NON_NECESSARIO);
	...
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
		VerificheEnums.TipoRifTemporale.MT_VERS_NORMA,
		componente.getAroMarcaComps().get(2).getTmMarcaTemp());
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(1),
		VerificheEnums.TipoRifTemporale.MT_VERS_NORMA,
		componente.getAroMarcaComps().get(1).getTmMarcaTemp());
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(2),
    ...
    @Test
    void testMarcheMultiple() throws Exception {
	...
	Util.assertNumeroDiBusteOK(componente, 1);
	Util.assertNumeroDiControfirmeOK(componente, 0);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.PADES,
		Util.SHA256RSA, 1);
	Util.assertControlloConformitaFirma(componente.getAroFirmaComps().get(0),
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlliFirmeOK(componente);
     ...
     */
    @Test
    void testPDFSig() throws Exception {
	...
	Util.assertNumeroDiBusteOK(componente, 1);
	Util.assertNumeroDiControfirmeOK(componente, 0);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.PDF_DSIG,
		Util.SHA1RSA, 1);
	Util.assertControlloConformitaFirma(componente.getAroFirmaComps().get(0),
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlliFirmeOK(componente);
    ...
    @Test
    void testPDFSigScaduta() throws Exception {
     ...
     */
    @Test
    void testCadesBES_ErroreCrittografico() throws Exception {
	...
	Util.assertNumeroDiBusteOK(componente, 1);
	Util.assertNumeroDiControfirmeOK(componente, 0);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.M7M,
		Util.SHA1RSA, 1);
	Util.assertFormatoMarcaOK(componente.getAroMarcaComps().get(0), SignerType.M7M,
		Util.SHA1RSA, 1);
	Util.assertControlliFirmeOK(componente);
	Util.assertControlliMarcheOK(componente);
	Util.assetRifTemporaleFirmaOK(componente.getAroFirmaComps().get(0),
    ...
    @Test
    void testMarcaSconosciuta() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/test_non_firma.xml");
    ...
    @Test
    void testFirmaSconosciuta() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/test_non_firma.xml");
	// File firmaDetached = new File(FILE_FOLDER + "/test_non_firma.xml");
	// Util.useDataVers(versManager);
	// verificaFirmeDetached(componente, fileWithSignature, sottoComponente, firmaDetached,
	// dataTest);
     ...
     */
    @Test
    void testXML_With_SignedDataObjectProperties() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER +
	// "/xades_con_signeddataobjectproperties.xml");
	// Util.useDataVers(versManager);
	// verificaFirme(componente, fileWithSignature, dataTest);
	//
	Resource fileFirmato = resourceLoader
	...
	Util.assertNumeroDiBusteOK(componente, 1);
	Util.assertNumeroDiControfirmeOK(componente, 0);
	Util.assertFormatoFirmaOK(componente.getAroFirmaComps().get(0), SignerType.XADES_BES,
		Util.XMLSHA256RSA, 1);
	Util.assertControlloConformitaFirma(componente.getAroFirmaComps().get(0),
		VerificheEnums.EsitoControllo.POSITIVO);
	Util.assertControlliFirmeOK(componente);
    ...
    /**
     * firma xml che noi la riconosciamo come xml dsig ma che il Laboratorio di Pievesestina
     * asserisce essere validamente una XADES
     *
     * @throws CryptoSignerException
     */
    @Test
    void testXML_SIG_conteso() throws Exception {
     ...
     */
    @Test
    void testPdfNullPointerEx_comunitaEuropea() throws Exception {
    ...
    /**
     * PDF non conforme. Probabilmente è un cades. Questo è un caso di test che utilizza la stessa
     * procedura della verifica firma; esegue un versamento fittizio passando anche dalla
     * validazione EIDAS.
     */
    @Test
    void testPdfNonConforme() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER + "/pades_non_conforme.pdf");
	// final List<File> noDetached = Collections.emptyList();
	// VerificaFirmeFormatiDto verificaTest = verificaFirme(fileWithSignature, noDetached,
	// noDetached, dataTest,
	...
	Util.assertNumeroDiControfirmeOK(componente, 0);
	// FIXME
	// Util.assertControlloConformitaFirma(componente.getAroBustaCrittogs().get(0).getAroFirmaComps().get(0),
	// VerificheEnums.EsitoControllo.FORMATO_NON_CONFORME);
    }

    @Test
    void testPdfFirmeMultipleErroreCritto() throws Exception {
	// File fileWithSignature = new File(FILE_FOLDER +
	// "/pades_3_firme_errore_contr_crittografico.pdf");
	// Date dataRiferimento = new
	// SimpleDateFormat(Constants.DATE_FORMAT_DATE_TYPE).parse("12/12/2017");
    ...
    @Test
    void testVersione() throws IOException {
	Resource fileFirmato = resourceLoader
		.getResource("classpath:firme/xades_con_signeddataobjectproperties.xml");
	CryptoDataToValidate input = new CryptoDataToValidate();
	input.setContenuto(new CryptoDocumentoVersato("documento-principale",
    ...
    @Test
    void testMimeComponentePrincipale() throws IOException {
	Resource fileFirmato = resourceLoader.getResource("classpath:firme/cades_T_1.pdf.p7m");
	Resource marcaDetached = resourceLoader
		.getResource("classpath:firme/cades_T_1.pdf.p7m.tsr");
    ...
    @Test
    void testSubjectCA() throws IOException {
    ...
    @Test
    void testComponenteTsr() throws IOException {
